...
function Hero() {
  return (
    <div className="flex flex-col lg:flex-row items-center lg:justify-between space-x-[8rem] bg-[#eef0f4] px-[2rem] pt-40 lg:pt-48 lg:pb-36 pb-24">
      ...
      <div className="lg:w-1/2 animate-delay-200 w-full pt-12 lg:pt-0 justify-self-end flex flex-col justify-center text-[#081158] text-blue-900">
        ...
        <h1 className="text-7xl  mb-12 text-[#081158] font-medium leading-[4.8rem]">
          Your go to online fitness trainer and nutritionist.
        </h1>
        <p className="w-[80%] leading-loose text-xl text-blue-900 mb-8">
